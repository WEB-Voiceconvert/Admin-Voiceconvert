            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between pb-0">
                        <h3>List Berita</h3>
                        <a href="{{ route('operator.berita.create') }}" class="btn btn-primary">Tambah</a>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <div class="d-flex justify-content-center gap-5">
                                                    <a href="{{ route('operator.berita.view', $berita->id) }}"
                                                        class="text-primary"><i class="fa-regular fa-eye"></i></a>
                                                    <a href="{{ route('operator.berita.edit', $berita->id) }}"
                                                        class="text-success"><i class="fa-regular fa-pen-to-square"></i></a>
                                                    <a href="{{ route('operator.berita.delete', $berita->id) }}"

                    ...
                    <div class="card-body p-3">
                        <form action="{{ route('admin.product.update', $product->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi" id="summernote" cols="30" rows="10">{{ $product->deskripsi }}</textarea>
                            </div>
                            ...
                            @foreach ($product->images as $image)
                                <div class="col-md-3 col-lg-2 my-3 mx-3 border rounded">
                                    <div class="d-flex flex-column align-items-center">
                                        <img src="/{{ $image->name }}" alt="{{ $image->name }}" width="100%" />
                                        <a href="{{ route('admin.product.image.delete', $image->id) }}" class="mt-3"><span

...
class EventController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('operator.event.index', compact('categories', 'events'));
    }
    ...
    public function create()
    {
        ...
        return view('operator.event.create', compact('categories', 'alats'));
    }
    ...
    AS distance")->orderBy('distance', 'asc')
        ...
        return redirect(route('operator.event.index'))->with('success', 'Event berhasil ditambahkan');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('operator.event.view', compact('event', 'alats'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('operator.event.edit', compact('categories', 'event', 'alats'));
    }
    ...
    AS distance")->orderBy('distance', 'asc')
        ...
        return redirect(route('operator.event.index'))->with('success', 'Event berhasil diupdate');
    }

...
class BeritaController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('operator.berita.create', compact('alats'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('operator.berita.view', compact('berita'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('operator.berita.edit', compact('berita', 'alats'));
    }
    ...
    AS distance")->orderBy('distance', 'asc')
        ...
        return redirect(route('operator.berita.index'))->with('success', 'Berita berhasil diupdate');
    }
